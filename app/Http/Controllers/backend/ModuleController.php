...
//        return view('backend.module.edit',compact('module','role'));
    ...
    public function destroy($id)
    {
        ...
        if ($module) {
           ...
           return redirect()->route('module.list')->with('success_message', 'You are successfully Deleted');
        } else {
            return redirect()->route('module.list')->with('error_message', 'You con not Deleted rignt now');
        }
    }
}
