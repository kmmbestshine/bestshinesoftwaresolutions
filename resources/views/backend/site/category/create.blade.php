                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group top_search" style="padding-left: 75px;">
                            <div class="input-group">
                                <a href="{{route('site.category.list')}}" class="btn btn-success">View Site Category</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="x_content">
                            <form action="{{route('site.category.store')}}" method="post">
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="btnCreate" class="btn btn-primary" >Save category</button>
                                </div>
                            </form>
                        </div>
                    </div>
