...
@section('content')
  ...
  <div class="wrapper hidden-xs">
       ...
       <div class="text-typ-wr">
        ...
        <h1> <marquee direction="left" >Welcome To Bestshine Software Solutions. We build Supermarket Inventory Billing software solutions that users love.</marquee></h1>
    </div>
        ...
        <div class="container">
            <div class="row  d-flex">
                <div class="col-lg-6 col-md-12 justify-content-top align-self-top">
                  <div class="row">
                      <div class="column" style="background-color:#b5dcb3;" style="overflow-x:auto;">
                        <h2>Advanced Modules</h2>
                         <p>1.Super Admin Management</p><p>2.Admin Management</p><p>3.Administrative Permission Management</p><p>4.Category Management</p><p>5.Purchase Management</p><p>6.Sales Management</p>
                      </div>
                      <div class="column" style="background-color:rgba(255, 99, 71, 0.5);" style="overflow-x:auto;">
                        <p>7.Billing System </p><p>8.Ventor Management</p><p>9.Stock Management</p><p>10.Bank Transaction Management</p><p>11.E-Commerce Site Management</p><p>12.Report Management</p><p>13.etc.....</p>
                      </div>
                    </div>
           ...
           <div class="carousel-inner" role="listbox"> 
                <div class="carousel-item active"> 
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero.jpg')}}"
                            alt="First slide"> 
                ...
                <div class="carousel-item"> 
                    ...
                    <!-- Slideer 1 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero1.jpg')}}"
                            alt="Second slide"> 
                ...
                <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero2.jpg')}}"
                            alt="Third slide"> 
                 ...
                 <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero3.jpg')}}"
                            alt="Third slide"> 
                        <div class="mask rgba-black-slight"></div> 
                    </div> 
                </div> 
                 <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero4.jpg')}}"
                            alt="Third slide"> 
                        <div class="mask rgba-black-slight"></div> 
                    </div> 
                </div> 
                <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero5.jpg')}}"
                            alt="Third slide"> 
                        <div class="mask rgba-black-slight"></div> 
                    </div> 
                </div> 
                 <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/supermarket/hero6.jpg')}}"
                            alt="Third slide"> 
                        <div class="mask rgba-black-slight"></div> 
                    </div> 
                </div> 
         ...
         <h3>Smart Solution for 
          <span
             ...
             data-rotate='[ "Admin Management.", "Purchase Management.", "Sales Management.", "Smart Billing.", "Report Management." ]'></span>
        </h3>
    </div>
