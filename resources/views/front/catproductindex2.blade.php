        ...
        <div class="container">
                  ...
                  <div class="row">
                      <div class="column" style="background-color:#b5dcb3;" style="overflow-x:auto;">
                        <h2>Advanced Modules</h2>
                         <p>1.Super Admin Management</p><p>2.Admin Management</p><p>3.Doctor Management</p><p>4.Administrative Permission Management</p><p>5.Online Appointment Management</p><p>6.Billing Management</p>
                      </div>
                      <div class="column" style="background-color:rgba(255, 99, 71, 0.5);" style="overflow-x:auto;">
                        <p>7.Medical Services </p><p>8.Doctor Services</p><p>9.Drugs Management</p><p>10.Patient Management</p><p>11.Lab-Test Management</p><p>12.Ward Management</p><p>13.Notice Board</p><p>14.etc.....</p>
                      </div>
                    </div>
                </div>
           ...
           <div class="carousel-inner" role="listbox"> 
                <div class="carousel-item active"> 
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/hospital/hero.jpg')}}"
                            alt="First slide"> 
                ...
                <div class="carousel-item"> 
                    ...
                    <!-- Slideer 1 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/hospital/hero1.jpg')}}"
                            alt="Second slide"> 
                ...
                <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/hospital/hero2.jpg')}}"
                            alt="Third slide"> 
                 ...
                 <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/hospital/hero3.jpg')}}"
                            alt="Third slide"> 
                        <div class="mask rgba-black-slight"></div> 
                    </div> 
                </div> 
                 <div class="carousel-item"> 
                    ...
                    <!-- Slideer 2 -->
                    <div class="view"> 
                        <img style='height: 100%; width: 100%; object-fit: contain' src= "{{url('tuttee/images/hospital/hero4.jpg')}}"
                            alt="Third slide"> 
                        <div class="mask rgba-black-slight"></div> 
                    </div> 
                </div> 
         ...
         <h3>Smart Solution for 
          <span
             ...
             data-rotate='[ "Hospital Admin Management.", "Doctors Management.", "Patient Management.", "Ward Management.", "Billing Management." 
             , "Report Management.", "Lab Management.", "Pharmacist Management.", "Appointment Management."]'></span>
        </h3>
    </div>
