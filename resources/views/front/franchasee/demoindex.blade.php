...
@section('content')
    ...
    <div class="col-md-12" id="register" >
        ...
        <div class="card col-md-8">
                ...
                <form action="{{ url('franch/postdemo') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field()}}
                    <div class="myvisit">
                                    <div class="row">
                                        <div class="col-md-5">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="images">Upload Demo Form:</label>
                        ...
                        <textarea name="address" placeholder="Address" id="address" class="form-control" required></textarea>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary float-md-right">Create Demo Form</button>
                                </div>
                </form>
