    ...
    <div class="col-md-12" id="register" >
        ...
        <div class="card col-md-8">
            ...
            @if(Session::has('success_message'))
                ...
                <form action="{{ url('franch/postserviceagree') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field()}}
                    <div class="myvisit">
                                    <div class="row">
                                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="hodname">Authorized Name:</label>
                        <input type="text" name="hodname" placeholder="Authorized Name" id="hodname" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="coord_contactno">Software Incharge Contact No:</label>
                        <input type="number" name="coord_contactno" placeholder="Software Incharge Contact No" id="coord_contactno" class="form-control">
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="number" name="no_of_student" placeholder="No Of Students" id="no_of_student" class="form-control">
                    </div>
                     ...
                     <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="images">Upload Service Agreement:</label>
                                <input type="file" name="images[]" id="images" class="form-control" multiple>
                                <small class="text-danger">You can use ctr (cmd) to select multiple images</small>
                            </div>
                        <div class="form-group">
                        ...
                        <textarea name="address" placeholder="Address" id="address" class="form-control" required></textarea>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary float-md-right">Create Service Agreement</button>
                                </div>
                </form>
